<x-app-layout>
                                ...
                                <td class="px-2 sm:px-6 py-4">
                                    <div class="flex flex-col sm:flex-row flex-wrap items-center justify-center gap-2">
                                        <a href="{{ route('orders.pdf', $order->id) }}"
                                            class="text-xs sm:text-sm font-semibold text-green-600 hover:text-green-800 px-3 py-1 rounded">Download PDF</a>
    ...
    <!-- Export Modal -->
    <div id="export-modal" class="fixed inset-0 z-50 bg-black bg-opacity-40 flex items-center justify-center hidden">
