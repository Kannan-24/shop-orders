<x-app-layout>
    <x-slot name="page-title">Edit Category</x-slot>
    <div class="py-0 lg:py-12">
        <div class="max-w-7xl mx-auto px-2 sm:px-4 lg:px-6">
            <!-- Page Title -->
            <div class="mb-6">
            <h1 class="text-2xl font-semibold text-gray-900">Edit Category</h1>
            <p class="text-gray-600 mt-1">Update category details below</p>
            </div>
            ...
            <div class="px-2 sm:px-4 py-4 border-b">
                ...
                <div class="ml-3">
                    ...
                    <p class="text-gray-500">Modify the category information below</p>
                </div>
                </div>
            </div>
            ...
            <form method="POST" action="{{ route('categories.update', $category) }}">
                ...
                <div class="w-full sm:w-3/4 md:w-1/2 gap-6">
                    ...
                    <div>
                        ...
                        class="w-full px-3 py-2 border border-gray-300 rounded-lg bg-white text-gray-900 focus:outline-none focus:ring-2 focus:ring-blue-500">{{ old('description', $category->description) }}</textarea>
                    </div>
                    </div>
                </div>
                </div>
