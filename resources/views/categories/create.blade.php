    ...
    <div class="py-4 sm:py-12">
        <div class="max-w-7xl mx-auto px-2 sm:px-4 lg:px-8">
            ...
            <div class="mb-4 sm:mb-8">
                <h1 class="text-2xl sm:text-3xl font-semibold text-gray-900">Create Category</h1>
                <p class="text-gray-600 mt-1 text-sm sm:text-base">Add a new category to the system</p>
            </div>
                ...
                <div class="px-2 py-3 sm:px-6 sm:py-6 border-b">
                    <div class="flex items-center">
                        ...
                        <div class="ml-2 sm:ml-4">
                            <h2 class="text-lg sm:text-xl font-semibold text-gray-900">Add Category</h2>
                            <p class="text-gray-500 text-xs sm:text-sm">Fill in the category information below</p>
                        </div>
                    </div>
                </div>
