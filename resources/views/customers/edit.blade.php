                ...
                <div class="px-6 py-6 border-b">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            ...
                            <p class="text-gray-500">Modify the customer details below</p>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="space-y-6">
                                ...
                                <div>
                                    ...
                                    <textarea name="address" id="address" rows="3"
                                        class="w-full px-4 py-2 border border-gray-300 rounded-lg bg-white text-gray-900 focus:outline-none focus:ring-2 focus:ring-blue-500  ">{{ old('address', $customer->address) }}</textarea>
                                </div>
                            </div>
                        </div>
                    </div>
