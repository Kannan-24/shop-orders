<x-app-layout>
    ...
    <div class="bg-gray-100 min-h-screen py-10">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <form method="GET" action="{{ route('customers.index') }}" class="mb-6 flex flex-wrap items-center gap-3">
                ...
                @if(request('search'))
                    <a href="{{ route('customers.index') }}" class="text-blue-600 hover:underline">Clear</a>
                @endif
            </form>
                ...
                <table class="min-w-full divide-y divide-gray-300 text-center">
                    <thead class="bg-gray-200">
                        <tr>
                            ...
                            <th class="px-6 py-3 font-semibold text-gray-700 text-center">Email</th>
                            <th class="px-6 py-3 font-semibold text-gray-700 text-center">Phone</th>
                    ...
                    <tbody class="divide-y divide-gray-200">
                        @forelse($customers as $customer)
                            <tr class="hover:bg-gray-50 transition-all text-center">
                                <td class="px-6 py-4">{{ $loop->iteration + ($customers->currentPage() - 1) * $customers->perPage() }}</td>
