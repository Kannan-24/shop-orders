                    ...
                    <tbody class="divide-y divide-gray-200">
                        @forelse($products as $product)
                            <tr class="hover:bg-gray-50 transition-all text-center">
                                ...
                                <td class="px-2 sm:px-6 py-4 text-xs sm:text-base">
                                    {{ number_format($product->base_price, 2) }}</td>
                                <td class="px-2 sm:px-6 py-4 text-xs sm:text-base">
                                    ({{ rtrim(rtrim($product->unit_value, '0'), '.') }}){{ $product->unit_type }}</td>
                        ...
                        @empty
                            <tr>
                                <td colspan="6"
                                    class="px-2 sm:px-6 py-4 text-center text-gray-500 text-xs sm:text-base">No products
                                    found.</td>
                            </tr>
                        @endforelse
                    </tbody>
